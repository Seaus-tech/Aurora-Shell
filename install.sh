#!/bin/bash
SHELL_VER="--- Aurora-Shell v5.6.1 installer---"
...
# --- VERSION CHECK ---
(curl -sf "https://raw.githubusercontent.com/Seaus-tech/Aurora-Shell/dev/install.sh" 2>/dev/null | grep '^VER=' | head -1 | sed 's/VER="\(.*\)"/\1/' | read REMOTE_VER
